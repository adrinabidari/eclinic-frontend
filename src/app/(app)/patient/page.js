...
import { AccountCircle, Dashboard, ReceiptLong, Today } from '@mui/icons-material';
...
const scheduleItems = [
    {
        ...
        icon: <Today />,
        activeUrls: ['/patient/appointments', '/patient/appointment-calendar-view']
    ...
    },
    {
        ...
        icon: <ReceiptLong />,
        activeUrls: ['/patient/transactions']
    },
];
...
const Patient = ({ children }) => {
    ...
    return (
        user.role_id == process.env.NEXT_PUBLIC_PATIENT_ID ?
            <Box sx={{ display: 'flex' }}>
                <AppBar
                    position="fixed"
                    sx={{
