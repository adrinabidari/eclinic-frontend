    ...
    const handleSubmit = async (values) => {
        ...
        try {
            const response = await axios
                .post('/api/specialization-create', formData)
                .then(res => {
                    messageApi.open({
                        type: 'success',
                        content: 'New specialization created sucessfully',
                    });
                    form.resetFields()
                    setLoading(false);
                })
                    ...
                    <div className="mb-8 flex justify-between">
                        <div>
                            ...
                            <p className="text-sm text-gray-600">
                                Fill the details below to add new specialization.
                            </p>
                        </div>
                        <div>
                            <Link href='/staff/specializations'>
                    ...
                    >
                        <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-9">
                                <Form.Item
                                    name="name"
                                    rules={[{ required: true, message: 'Please enter the specialzation' }]}
                                >
                                    <Input
                                        type="text"
