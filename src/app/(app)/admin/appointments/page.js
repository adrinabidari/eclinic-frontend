...
const columns = [
    ...
    },
    {
        title: 'Date',
        dataIndex: 'date',
        sorter: (a, b) => compareDates(a.date, b.date), // Add sorting function here
    },
    {
            ...
            return (
                <Space size="middle">
                    <Button shape="circle" icon={<EditOutlined />}
                        onClick={() => router.push(`/admin/appointments/${record.id}`)}
                    />
    ...
    return (
        <Admin>
            <div className='flex justify-between mb-5'>
                ...
                <div>
                    <Link href='/admin/appointment-calendar-view'>
